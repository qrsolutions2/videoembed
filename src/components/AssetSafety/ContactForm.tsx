...
const ContactForm: React.FC = () => {
  ...
  return (
    <section id="contact-form" className="bg-white p-8 rounded-lg shadow-lg mb-16">
      ...
      <div className="mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <button
            type="button"
            onClick={() => handleChange({ target: { name: 'managementType', value: 'self' } } as any)}
            className={`p-4 border rounded-lg text-left transition-all ${
              formData.managementType === 'self' 
          ...
          <button
            type="button"
            onClick={() => handleChange({ target: { name: 'managementType', value: 'managed' } } as any)}
            className={`p-4 border rounded-lg text-left transition-all ${
              formData.managementType === 'managed' 
                ? 'border-blue-500 bg-blue-50' 
                : 'border-gray-200 hover:border-blue-300'
            }`}
          >
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          <button
            ...
            className="w-full bg-blue-600 text-white px-6 py-3 rounded-lg font-medium hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors duration-300"
          >
